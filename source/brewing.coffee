...
{render, doctype, html, head, meta, link, style, title, script, body, coffeescript, header, section, nav, footer, h1, h2, ul, li, a, p} = require 'teacup'

coffee = require 'coffee-script.coffee'
  ...
  output = render ->
    ...
    html ->
      ...
      head -> ### head = title, styles, font ###
        meta charset: 'utf-8'

        title 'Coffee Brewing'

        link href: 'styles.css', ### integrate styles ###
        rel: 'stylesheet',
        type: 'text/css'

        link href: 'https://git.io/v9Ra9', ### set font to 'roboto slab' ###
        rel: 'stylesheet'


      body -> ### body = coffee making techniques ###

        section -> ### 0 making / brewing coffee ###
        ...
        section -> ### 3 filtration ###
          ...
          h3 '#filtration', 'Filtration methods'
